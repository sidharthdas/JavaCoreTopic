package practice17.bst;

//BST with full functionalities
...
class BST {
	...
	/*
	 * 1. Insert Node 2. Check Node 3. Delete Node 4. Height of BST 5. Mirror image
	 * of BST 6. inOrder 7. preOrder 8. postOrder
	 */
	...
	public Node remove(Node node, int data) {
		...
		if (data < node.data) {
			...
			if (node.left == null || node.right == null) {
				...
				node.right = remove(node, succesor.data);
			}
		}
